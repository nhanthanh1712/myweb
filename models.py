...
class Project(db.Model):
    ...
    def __repr__(self):
        return 'Trạng thái: {} Task cùng với Project {}>'.format(self.status_id, self.description)
class Task(db.Model):
...
class Status(db.Model):
    ...
    def __repr__(self):
        return 'Trạng thái: {} cùng với {} đang thực hiện'.format(self.status_id, self.description)
